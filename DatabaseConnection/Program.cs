...
namespace DatabaseConnectionApp
{
    ...
    {
        SqlConnection conn = new SqlConnection("Server=5CD413896K\\DEMOINSTANCE;Integrated Security=true;Initial Catalog=NorthWind;TrustServerCertificate=True");
        ...
        void UnderstandingDisconnectedArchitecture()
        {
            ...
            adapter.SelectCommand = new SqlCommand("SELECT P.CategoryID FROM Products P", conn);
